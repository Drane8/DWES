...
--
-- Base de datos: `bdalumnosweb`
--

--
CREATE DATABASE IF NOT EXISTS `bdalumnosweb` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
USE `bdalumnosweb`;
...
INSERT INTO `alumnos` (`num_part`, `nombre`, `apellido`, `DNI`, `edad`, `modulo`, `nota`, `curso`, `Idiomas`) VALUES
